...
namespace Wellcome.Database.Migrations
{
    ...
    [Migration("20220312214613_Trips")]
    partial class Trips
    {
            ...
            modelBuilder.Entity("Wellcome.DataModel.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notation = 4,
                            Remark = "Good host !",
                            TimeStamp = new DateTime(2022, 3, 12, 22, 46, 13, 59, DateTimeKind.Local).AddTicks(2025),
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("Wellcome.DataModel.Host", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = 1,
                            Uuid = "fb916065-a77b-4ebb-8027-a771bd4914e3"
                        });
                });
            ...
            modelBuilder.Entity("Wellcome.DataModel.HostReservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 2,
                            HostId = 1,
                            EndDate = new DateTime(1999, 9, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Message = "Hello, I want to stay !",
                            Phone = "0668319800",
                            StartDate = new DateTime(1999, 9, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "Waiting",
                            Uuid = "37b8367d-a817-475a-a1b0-ea9ad1b70e7d"
                        });
                });
            ...
            modelBuilder.Entity("Wellcome.DataModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Age = 31,
                            BirthDate = new DateTime(2022, 3, 12, 21, 46, 13, 59, DateTimeKind.Utc).AddTicks(1930),
                            ContactId = 1,
                            ...
                            Uuid = "7dd7dff5-077f-4c8a-b442-53755a0233e8"
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Password = "password",
                            Profession = "It Engineer",
                            Uuid = "464562f8-1fd5-476d-88a9-0fc4ca394de5"
                        });
                });
